   ...
   <>
    ...
    return(
        ...
        <aside id="asideshop">
          ...
          <Link style={{textDecoration:"none"}}  to="/PhonesShop">  <p id="shop-side-items"> Ipad Phone & Tablets <FontAwesomeIcon icon={faChevronRight} style={{marginTop:"5px"}}/> </p>  </Link>    <hr />
        ...
        <Link to="/PhonesShop">  <img src={phonebanner2} alt="" id="aside-img" style={{height:"100%",width:"100%"}} /></Link>
        </div>
        <div id="aside-d3">
           <div id="aside-d3-img">
        ...
        <div id="shop-main">
          <div id="shop-head">
         <Link to="/PhonesShop"> <img src={phonebanner1} alt="" /> </Link>
