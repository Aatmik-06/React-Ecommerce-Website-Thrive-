...
const Virtual =()=>{
  ...
  const gotoview=(id)=>{
    ...
    const loadData=()=>{
        let api="https://react-e-commerce-json.onrender.com/shop/?category=virtual Palner";
  ...
  if (key.price>=lowPrice && key.price<=highPrice)
    ...
    return(
        ...
        <aside id="asideshop">
          ...
          <Link style={{textDecoration:"none"}}  to="/Virtual">  <p id="shop-side-items"> Virtual devices & Planer <FontAwesomeIcon icon={faChevronRight} style={{marginTop:"5px"}}/> </p>  </Link>    <hr />
